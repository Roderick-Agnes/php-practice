...
<body>
    ...
    $array_image_year = array(
        "https://c.tenor.com/yw_WlSzbed4AAAAC/pig-angry.gif",
    ...
    <div class="container p-5 w-50">
        <label class="alert bg-info w-100 text-white text-center">TÍNH NĂM ÂM LỊCH</label>
        <form action="ex13.php" method="post" class="alert alert-success">
            ...
            <a class="ripple  d-flex justify-content-center" href="">
                <img alt="example" class="img-fluid rounded" accept="image/*" width="50%" height="auto" src="<?php echo $image_year ?>" />
            </a>
        </form>
    </div>
